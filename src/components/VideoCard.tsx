...
export function VideoCard({ video, hasAccess, onClick }: VideoCardProps) {
  return (
    ...
    >
      <div className="relative aspect-[2/3] rounded-lg sm:rounded-xl overflow-hidden bg-gray-900 shadow-lg">
        <img
        ...
        {!hasAccess && (
          <div className="absolute bottom-12 sm:bottom-14 md:bottom-16 right-2 sm:right-2.5 bg-black/75 backdrop-blur-sm text-white text-sm sm:text-base font-bold px-2 sm:px-3 py-1 sm:py-1.5 rounded-md sm:rounded-lg">
